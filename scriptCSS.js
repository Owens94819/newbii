window.nimoLESS=function(){
 _starter_={script:null,script_length:null,a:null,b:null},
 nimo_arr=nimoID;
 for(var e=0;e<nimo_arr.length;e++){
  ...
  old__script.href?(old__script.href="data:text/css;base34,body{opacity:0;}",
  setTimeout(function(){
   old__script.href="data:text/css;base34,body{opacity:1;}"
  },1e3)
  ):
  old__script.innerHTML&&(old__script.innerHTML="body{opacity:0;}",
  setTimeout(function(){
   old__script.innerHTML="body{opacity:1;}"
  },1e3)),
  setTimeout(function(){
   var e=document.head,
   n=document.body;
